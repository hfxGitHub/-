...
! function(t, e) {
	...
	var nI = {
		...
		uI = function(t, e) {
			...
			function o(t) {
				return lI.series.typeNames[t] || "鑷畾涔夊浘"
			}
	...
	var fA = {
		...
		mA = [function(t) {
			"china" === t.map && t.regions.push(new Cl("鍗楁捣璇稿矝", f(hA, function(t) {
				return {
					type: "polygon",
					exterior: t
				}
			...
			if("china" === t.map)
				for(var e = 0, i = t.regions.length; e < i; ++e) "鍙版咕" === t.regions[e].name && t.regions[e].geometries.push({
					type: "polygon",
					exterior: gA[0]
				})
		}];
